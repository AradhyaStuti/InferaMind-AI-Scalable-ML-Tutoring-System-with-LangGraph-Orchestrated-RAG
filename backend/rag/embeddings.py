"""LangChain FAISS embedding service with LRU cache for repeated queries."""
...
class EmbeddingService:
    ...
    def load(self):
        """Load the pre-computed embeddings for the 4 course videos."""
        ...
        logger.info(f"Loaded {len(self.df)} default chunks into FAISS")

    def search(self, query: str, top_k: int = TOP_K) -> list[dict]:
        """Search with LRU cache — cache key is (query, top_k)."""
