"""LangGraph routing: classify → retrieve / direct / off-topic."""
...
# Mean embedding of these phrases is the "course centroid" — queries are
# scored by cosine similarity to it.
COURSE_ANCHORS = [
