"""Whisper-transcribe every audio file in ./audios and dump chunks to jsons.json."""
...
with open("jsons.json", "w", encoding="utf-8") as f:
    json.dump({"chunks": all_chunks, "texts_per_file": all_texts}, f, ensure_ascii=False, indent=2)
